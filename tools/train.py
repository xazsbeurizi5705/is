...
def parse_args(args):
    ...
    parser.add_argument('--config', help='train config file path',default='/hy-tmp/01-DAFormer/configs/daformer/cs2acdc_400_uda_2teacher_rcs_croppl_a999_daformer_mitb5_s0.py')
#cs2acdc_400_uda_2teacher_rcs_croppl_a999_daformer_mitb5_s0.py，gta2cs_uda_warm_fdthings_rcs_croppl_a999_daformer_mitb5_s0.py
